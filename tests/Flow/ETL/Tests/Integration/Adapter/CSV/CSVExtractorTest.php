...
namespace Flow\ETL\Tests\Integration\Adapter\CSV;
...
final class CSVExtractorTest extends TestCase
{
    ...
    {
        $extractor = CSV::from(
            new LocalFile(__DIR__ . '/../Fixtures/CSV/file_with_empty_columns.csv'),
            empty_to_null: false
        );
    ...
    public function test_extracting_csv_files_from_directory_recursively() : void
    {
        $extractor = CSV::from(
            [
                new LocalFile(__DIR__ . '/../Fixtures/CSV/annual-enterprise-survey-2019-financial-year-provisional-csv.csv'),
                new LocalFile(__DIR__ . '/../Fixtures/CSV/nested/annual-enterprise-survey-2019-financial-year-provisional-csv.csv'),
            ],
            1000,
            false
        );
    ...
    {
        $path = __DIR__ . '/../Fixtures/CSV/annual-enterprise-survey-2019-financial-year-provisional-csv.csv';
    ...
    {
        $extractor = CSV::from(
            __DIR__ . '/../Fixtures/CSV/annual-enterprise-survey-2019-financial-year-provisional-csv.csv',
            5,
            false
        );
    ...
    {
        $extractor = CSV::from(
            new LocalFile(__DIR__ . '/../Fixtures/CSV/more_columns_than_headers.csv')
        );
    ...
    {
        $extractor = CSV::from(
            new LocalFile(__DIR__ . '/../Fixtures/CSV/more_headers_than_columns.csv')
        );
