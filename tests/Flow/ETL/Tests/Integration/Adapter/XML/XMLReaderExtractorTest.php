...
final class XMLReaderExtractorTest extends TestCase
{
    public function test_reading_xml_collection() : void
    {
        $this->assertEquals(
            ...
            (new Flow())
                ->read(XML::from_file(__DIR__ . '/../Fixtures/XML/simple_items.xml', 'root/items'))
                ->fetch()
        );
    }
    ...
    public function test_reading_xml_each_collection_item() : void
    {
        $this->assertEquals(
            ...
            (new Flow())
                ->read(XML::from_file(__DIR__ . '/../Fixtures/XML/simple_items.xml', 'root/items/item'))
                ->fetch()
        );
    }
    ...
    public function test_reading_xml_each_collection_item_id() : void
    {
        $this->assertEquals(
            ...
            (new Flow())
                ->read(XML::from_file(__DIR__ . '/../Fixtures/XML/simple_items.xml', 'root/items/item/id'))
                ->fetch()
        );
    }
    ...
    public function test_reading_xml_root() : void
    {
        $this->assertEquals(
            ...
            (new Flow())
                ->read(XML::from_file(__DIR__ . '/../Fixtures/XML/simple_items.xml'))
                ->fetch()
        );
    }
}
