...
namespace Flow\ETL\Tests\Integration\Adapter\Text;
...
final class TextExtractorTest extends TestCase
{
    ...
    {
        $path = __DIR__ . '/../Fixtures/Text/annual-enterprise-survey-2019-financial-year-provisional-csv.csv';
    ...
    public function test_extracting_text_files_from_directory() : void
    {
        $extractor = Text::from(
            [
                new LocalFile(__DIR__ . '/../Fixtures/Text/annual-enterprise-survey-2019-financial-year-provisional-csv.csv'),
                new LocalFile(__DIR__ . '/../Fixtures/Text/nested/annual-enterprise-survey-2019-financial-year-provisional-csv.csv'),
            ],
        );
